...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  KC_LGUI,
                                                 TG(3),   LANG_TG,
                                                          _______,
                                        MO(1),   CTL_A,   _______,
  ...
  [2] = LAYOUT_ergodox(
    ...
    _______, _______, _______, _______, _______,
                                        ...
                                        _______, _______, _______,
                                                                    ...
                                                                    _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   KC_F12,
                                                                             _______, _______, KC_P4,   KC_P5,   KC_P6,   _______,
                                                                    _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   _______,
                                                                                      _______, _______, _______, _______, _______,
                                                                    _______, RESET,
                                                                    _______,
                                                                    _______, _______, _______
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch(keycode) {
    ...
    case KC_L:
      modded_key_press(record, KC_L, KC_RGHT, &modded_l_pressed);
      return false;
