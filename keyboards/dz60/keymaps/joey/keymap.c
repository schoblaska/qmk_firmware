...
* |-----------------------------------------------------------------------------------------+
* | Ctrl  |  Alt |  GUI |     Space     |  Fn1 |   Space    | Alt  | Fn1 |      |App | Ctrl |
* `-----------------------------------------------------------------------------------------'
*/
	...
	LAYOUT_all(
		...
		KC_LSFT, _______, KC_Z,    KC_X,   KC_C,  KC_V,    KC_B,    KC_N,  KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  _______,  KC_RSFT, RGB_TOG,
		KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, MO(1), KC_SPC,  KC_RALT, MO(1), _______, KC_APP, KC_RCTL),
...
*/
  ...
  LAYOUT_all(
		...
		_______, _______, _______, _______, _______, KC_MSTP, _______, _______, KC_MPRV, KC_VOLD, KC_MNXT),
};
