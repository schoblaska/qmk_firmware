...
//
// note: may finish with "Error 254", but that is OK (I think?)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_tkl_split_shift(
      ...
      KC_LSFT, _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, LANG_TG,             KC_UP,
      KC_LCTL, KC_LALT, KC_LGUI,          KC_LGUI, KC_SPC,                                      KC_RALT, MO(1),   TG(2),   KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT  ),
  ...
  [1] = LAYOUT_tkl_split_shift(
      ...
      _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______, _______, _______,
